...
<div class="flex gap-2 mb-6 flex-wrap">
    <a href="{{ route('admin.pengguna') }}" class="px-4 py-2 rounded-lg text-sm font-bold transition-colors bg-dark text-white">Semua</a>
    <a href="#" class="px-4 py-2 rounded-lg text-sm font-bold transition-colors bg-white text-gray-600 border border-gray-200 hover:bg-gray-50">Klien</a>
    <a href="#" class="px-4 py-2 rounded-lg text-sm font-bold transition-colors bg-white text-gray-600 border border-gray-200 hover:bg-gray-50">Freelancer</a>
</div>
